...
#define STRING_CONFIG_H_AUTHOR "(Rudolph van Staden, Geco 3D MK 1)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Geco 3D MK1"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 27.8, 3.8, 0 }
